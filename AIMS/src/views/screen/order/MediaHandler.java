...
public class MediaHandler extends FXMLScreenHandler {
    ...
    private static Logger LOGGER = Utils.getLogger(views.screen.cart.MediaHandler.class.getName());
    ...
    private OrderScreenHandler cartScreen;

    public MediaHandler(String screenPath, OrderScreenHandler cartScreen) throws IOException {
        super(screenPath);
